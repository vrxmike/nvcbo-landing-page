          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 w-full max-w-4xl mx-auto">
            {CATEGORIES.map((category) => (
              <button
                ...
                className={`w-auto text-center whitespace-nowrap px-4 sm:px-6 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold tracking-wider transition-all duration-300 border ${
