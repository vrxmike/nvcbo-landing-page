    ...
    <div className="flex flex-col min-h-screen bg-white pt-24 pb-32">
      ...
      <section className="py-8 px-6 border-y border-muted/30 bg-neutral-light/30 sticky top-20 z-30 backdrop-blur-md">
        <div className="container max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:flex-wrap md:justify-center gap-2.5 sm:gap-3 w-full">
            {CATEGORIES.map((category) => (
              <button
                key={category.id}
                onClick={() => setActiveCategory(category.id)}
                className={`w-full md:w-auto text-center whitespace-nowrap px-6 py-2.5 rounded-full text-sm font-bold tracking-wider transition-all duration-300 border ${
