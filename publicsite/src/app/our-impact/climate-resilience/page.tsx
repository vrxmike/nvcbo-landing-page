    ...
    <div className="flex flex-col bg-white min-h-screen pt-24 pb-32">
      ...
      <section className="pt-16 pb-20 px-6 relative overflow-hidden bg-brand-cream border-b border-black/5">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <Link href="/our-impact" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand-rust hover:text-brand-gold transition-colors mb-8 w-fit mx-auto">
            <ArrowRight className="w-4 h-4 rotate-180" /> Back to Our Impact Tracks
          </Link>
