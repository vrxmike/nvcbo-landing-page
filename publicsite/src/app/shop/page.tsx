  ...
  return (
    <main className="min-h-screen bg-neutral-light pb-24">
      ...
      <section className="py-16 bg-neutral-light border-b border-muted/50">
        <div className="container">
          <div className="bento-card bg-heading text-white p-10 md:p-12 rounded-[2rem] shadow-xl max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 animate-up delay-2">
