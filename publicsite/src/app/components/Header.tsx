  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 bg-white/75 backdrop-blur-md border-b border-nvcbo-orange/10 py-4 shadow-sm transition-all duration-300">
      <div className="container mx-auto px-3 md:px-4 lg:px-8 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-0.5 lg:gap-1 bg-nvcbo-stone/5 border border-nvcbo-stone/10 px-1.5 lg:px-3 py-1 rounded-full shadow-inner shrink-0">
          <Link href="/" className="whitespace-nowrap font-bold text-[9px] lg:text-xs uppercase tracking-widest px-2 lg:px-4 py-1.5 rounded-full text-nvcbo-stone hover:bg-nvcbo-stone/5 hover:text-nvcbo-orange transition-all duration-300">Home</Link>
          
          {/* About Us Dropdown */}
          <div className="relative group">
            <button className="whitespace-nowrap flex items-center gap-0.5 lg:gap-1 font-bold text-[9px] lg:text-xs uppercase tracking-widest px-2 lg:px-4 py-1.5 rounded-full text-nvcbo-stone hover:bg-nvcbo-stone/5 hover:text-nvcbo-orange transition-all duration-300 focus:outline-none">
          ...
          {/* Projects Dropdown */}
          <div className="relative group">
            <button className="whitespace-nowrap flex items-center gap-0.5 lg:gap-1 font-bold text-[9px] lg:text-xs uppercase tracking-widest px-2.5 lg:px-4 py-1.5 rounded-full text-nvcbo-stone hover:bg-nvcbo-stone/5 hover:text-nvcbo-orange transition-all duration-300 focus:outline-none">
          ...
          <Link href="#donate" className="whitespace-nowrap flex items-center gap-1 font-bold text-[9px] lg:text-xs uppercase tracking-widest px-2 lg:px-4 py-1.5 rounded-full text-nvcbo-stone hover:bg-nvcbo-stone/5 hover:text-nvcbo-orange transition-all duration-300">
            Shop <span className="bg-nvcbo-orange text-white text-[8px] font-black px-1.5 py-0.5 rounded-full shrink-0">New</span>
          </Link>
          
          <Link href="#contact" className="whitespace-nowrap inline-flex items-center justify-center px-3 lg:px-5 py-1.5 rounded-full font-extrabold uppercase tracking-widest bg-gradient-to-br from-nvcbo-orange to-nvcbo-dark-orange text-white shadow-[0_4px_10px_rgba(204,85,0,0.25)] hover:scale-105 transition-all duration-300 text-[9px] lg:text-xs ml-1 shrink-0">Contact</Link>
        </nav>
      ...
      <div className={`fixed inset-0 w-full h-full bg-nvcbo-stone/95 backdrop-blur-xl transform transition-transform duration-300 ease-in-out z-50 ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="p-6 flex justify-between items-center border-b border-white/10">
          ...
          <button onClick={() => setMobileMenuOpen(false)} className="text-white p-2 glass rounded-full hover:bg-white/10 transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>

        <nav className="flex flex-col gap-3 p-6 text-white text-md font-bold overflow-y-auto max-h-[calc(100vh-100px)]">
          <Link onClick={() => setMobileMenuOpen(false)} href="/" className="hover:text-nvcbo-orange transition py-1">Home</Link>

          {/* About Accordion */}
          <div className="space-y-1">
            <button className="flex w-full items-center justify-between py-1 hover:text-nvcbo-orange transition focus:outline-none" onClick={() => toggleAccordion('about')}>
              <span>About Us</span>
            ...
            <div className={`pl-4 space-y-1.5 border-l border-white/15 transition-all duration-300 overflow-hidden ${openAccordions.about ? 'max-h-48 opacity-100 mt-2' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              <Link onClick={() => setMobileMenuOpen(false)} href="#about" className="block text-sm py-1 hover:text-nvcbo-orange/80">Our Story</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#about" className="block text-sm py-1 hover:text-nvcbo-orange/80">What We Believe</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#about" className="block text-sm py-1 hover:text-nvcbo-orange/80">How We Work</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#about" className="block text-sm py-1 hover:text-nvcbo-orange/80">Our Partners</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#about" className="block text-sm py-1 hover:text-nvcbo-orange/80">2025 Review</Link>
            </div>
          </div>

          {/* Programs Accordion */}
          <div className="space-y-1">
            <button className="flex w-full items-center justify-between py-1 hover:text-nvcbo-orange transition focus:outline-none" onClick={() => toggleAccordion('programs')}>
              <span>Programs</span>
            ...
            <div className={`pl-4 space-y-1.5 border-l border-white/15 transition-all duration-300 overflow-hidden ${openAccordions.programs ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Circle Keeper Training</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Gender & Social Inclusion</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Peace and Security</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Education & Youth Leadership</Link>
            </div>
          </div>

          {/* Projects Accordion */}
          <div className="space-y-1">
            <button className="flex w-full items-center justify-between py-1 hover:text-nvcbo-orange transition focus:outline-none" onClick={() => toggleAccordion('projects')}>
              <span>Projects</span>
            ...
            <div className={`pl-4 space-y-1.5 border-l border-white/15 transition-all duration-300 overflow-hidden ${openAccordions.projects ? 'max-h-48 opacity-100 mt-2' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Climate Resilience</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Gotu Gamachu Farm</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Eco-Tourism Hub</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Digital Literacy Camp</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#programs" className="block text-sm py-1 hover:text-nvcbo-orange/80">Indigenous Knowledge</Link>
            </div>
          </div>

          {/* Media Hub Accordion */}
          <div className="space-y-1">
            <button className="flex w-full items-center justify-between py-1 hover:text-nvcbo-orange transition focus:outline-none" onClick={() => toggleAccordion('media')}>
              <span>Media Hub</span>
            ...
            <div className={`pl-4 space-y-1.5 border-l border-white/15 transition-all duration-300 overflow-hidden ${openAccordions.media ? 'max-h-24 opacity-100 mt-2' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              <Link onClick={() => setMobileMenuOpen(false)} href="#healing" className="block text-sm py-1 hover:text-nvcbo-orange/80">Stories & News</Link>
              <Link onClick={() => setMobileMenuOpen(false)} href="#healing" className="block text-sm py-1 hover:text-nvcbo-orange/80">Media Gallery</Link>
            </div>
          </div>

          <Link onClick={() => setMobileMenuOpen(false)} href="#donate" className="flex items-center justify-between py-1 hover:text-nvcbo-orange transition">
            <span>Shop</span>
            <span className="bg-white text-nvcbo-dark-orange text-[9px] uppercase font-black px-2 py-0.5 rounded-full">New</span>
          </Link>

          <Link onClick={() => setMobileMenuOpen(false)} href="#contact" className="hover:text-nvcbo-orange transition py-1">Contact</Link>
