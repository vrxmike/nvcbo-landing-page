        ...
        <nav className="flex flex-col gap-3 p-6 text-brand-cream text-md font-bold overflow-y-auto h-[calc(100dvh-85px)]">
          ...
          <div className="space-y-1">
            ...
            <div className={`pl-4 space-y-1.5 border-l border-white/15 transition-all duration-300 overflow-hidden ${openAccordions.programs ? 'max-h-64 opacity-100 mt-2' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              <Link onClick={() => setMobileMenuOpen(false)} href="/programs" className="flex items-center gap-3 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-brand-gold hover:bg-brand-gold/10 hover:pl-5 rounded-xl transition-all duration-300"><ArrowRight className="w-4 h-4" /> All Programs Directory</Link>
              <div className="h-px bg-brand-cream/10 my-1 mx-4"></div>
